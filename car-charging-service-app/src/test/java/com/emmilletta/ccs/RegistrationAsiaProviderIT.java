...
class RegistrationAsiaProviderIT {
    ...
    @Test
    void deregistratioWrongProviderUserId() throws Exception {
        UserEntity user = createUser();
    ...
    private UserEntity createUser() {
        UserEntity user = UserEntity.builder().userId("testUserId").providerUserId("testProviderUserId")
